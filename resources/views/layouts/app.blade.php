...
{{--@yield('title', 'SFECE')--}}
    ...
    <script data-ad-client="ca-pub-5393433351100419" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
...
<div class="container">
    <div class="row" style="background-color: #eee">
        ...
        <div style="clear:both;display:block">
            ...
            <!--<div style="border:1px dashed #000;height:100px; background:#eddc99;">-->
            <!--    <script data-ad-client="ca-pub-5393433351100419" async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>-->
            <!--</div>-->
            <!--</div>-->
        <!-- Footer -->
        <footer>
            <div class="r-ow footer">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="fb-page" data-href="{{Setting::getIfExists('facebook','https://www.facebook.com/sffece/')}}"
                        ...
                        <blockquote cite="{{Setting::getIfExists('facebook','https://www.facebook.com/sfece/')}}" class="fb-xfbml-parse-ignore"></blockquote>
                    </div>
                    @endif
                </div>
                </div>
            ...
            <div class="col-xs-12 text-center">
                @foreach(Func::menu('header-social') as $link)
                    <a href="{{ Func::menuLink($link)}}" target="_blank" style="color:#fff">
                        {!! $link->title !!}
                    </a>
                @endforeach
            </div>
            <div class="footer-copyright">
                <p class="m-0 text-center text-white">&copy; {{ trans('app.Copyright') }} 
                    <a href="https://www.web-egy.com/" target="_blank" style="color:#ccc;text-decoration:none;"> WEBEGY </a></p>
            </div>
        </footer>
    </div>
</div>
          ...
          @endforeach
            ...
            {{Form::hidden('post_type_id',3)}}
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        {{Form::select("category_id",App\Models\Category::listsTranslations('title')->where('parent_id',2)->pluck('title','id'),null,["required",'class'=>'form-control','placeholder'=>'Select one ..'])}}
                    </div>
                </div>
                <div class="form-group">
